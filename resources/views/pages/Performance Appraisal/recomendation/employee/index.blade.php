...
@section('title', 'Form Promotion Recommendation Appraisal')

@section('main')
<div class="main-content">
    <section class="section">
        <div class="section-header">
            <h1>Form Promotion Recommendation Appraisal</h1>
        </div>
    ...
    <form action="{{ route('recommendation.update', $employee->uuid) }}" method="post">
        @csrf
        ...
        @include('pages.Performance Appraisal.form.promotion')
        <div class="d-flex">
